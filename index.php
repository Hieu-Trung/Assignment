<html>
 ...
 <body>
	<h2 style="text-align: center;">Hello Teacher</h2> 	
 	...
 	<br>
 	<br>
     <a href="ConnectToDB.php" target="_blank" style="border: 1px solid; float: left; margin-left: 300px; margin-top: 55px; text-decoration: none; color: red;" >Connect database</a>
     <br/>
