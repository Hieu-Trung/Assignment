<html>
 ...
 <body>
	<h2 style="text-align: center;">Hello Teacher</h2> 	
 	...
 	<br>
 	<br>
     <a href="ConnectToDB.php" target="_blank" style="border: 1px solid yellow; float: left; margin-left: 300px; margin-top: 55px; text-decoration: none; color: red;" >Connect database</a>
     <br/>
     <a href="InsertData.php" target="_blank" style="border: 1px solid; float: left; margin-left: 50px; margin-top: 36px; text-decoration: none;">Insert data to the database</a>
     <br/>
